...
public class SpeakerGainPreference extends Preference implements
        SeekBar.OnSeekBarChangeListener {

    private static final String TAG = "SpeakerGainPreference";

    protected static String SETTINGS_KEY = DeviceSettings.KEY_SETTINGS_PREFIX + DeviceSettings.KEY_SPEAKER_GAIN;
    ...
    public static String getDefaultValue(Context context) {
        return isSupported() ? Integer.toString(context.getResources().getInteger(R.integer.audioSpeakerGainDefault)) :
                                Integer.toString(0);
    }
