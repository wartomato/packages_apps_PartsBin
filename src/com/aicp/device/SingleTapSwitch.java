...
public class SingleTapSwitch implements OnPreferenceChangeListener {

    public static final String SETTINGS_KEY = DeviceSettings.KEY_SETTINGS_PREFIX + DeviceSettings.KEY_STAP_SWITCH;

    private Context mContext;

    public SingleTapSwitch(Context context) {
        mContext = context;
    }

    public static String getFile(Context context) {
        String fileName = context.getResources().getString(R.string.pathSTapToggle);
