...
public class DoubleTapToWakeSwitch implements OnPreferenceChangeListener {

    public static final String SETTINGS_KEY = DeviceSettings.KEY_SETTINGS_PREFIX + DeviceSettings.KEY_DT2W_SWITCH;

    private Context mContext;

    public DoubleTapToWakeSwitch(Context context) {
        mContext = context;
    }

    public static String getFile(Context context) {
        String fileName = context.getResources().getString(R.string.pathDoubleTapToWakeToggle);
