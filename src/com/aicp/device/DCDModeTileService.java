...
@TargetApi(24)
public class DCDModeTileService extends TileService {
    ...
    public void onStartListening() {
        ...
        enabled = DCDModeSwitch.isCurrentlyEnabled(this);
    ...
    public void onClick() {
        ...
        SharedPreferences sharedPrefs = PreferenceManager.getDefaultSharedPreferences(this);
        enabled = DCDModeSwitch.isCurrentlyEnabled(this);
        Utils.writeValue(DCDModeSwitch.getFile(this), enabled ? "0" : "1");
