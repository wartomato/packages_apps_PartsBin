...
public class SweepToWakeSwitch implements OnPreferenceChangeListener {
    ...
    public static final String SETTINGS_KEY = DeviceSettings.KEY_SETTINGS_PREFIX + DeviceSettings.KEY_S2W_SWITCH;

    private Context mContext;

    public SweepToWakeSwitch(Context context) {
        mContext = context;
    }

    public static String getFile(Context context) {
        String fileName = context.getResources().getString(R.string.pathSweepToWakeToggle);
