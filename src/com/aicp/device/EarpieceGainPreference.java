...
public class EarpieceGainPreference extends Preference implements
        SeekBar.OnSeekBarChangeListener {

    private static final String TAG = "EarpieceGainPreference";

    protected static String SETTINGS_KEY = DeviceSettings.KEY_SETTINGS_PREFIX + DeviceSettings.KEY_EARPIECE_GAIN;
    ...
    public EarpieceGainPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
