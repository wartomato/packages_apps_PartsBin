...
public class OnePlusModeSwitch {
    ...
    public static final String SETTINGS_KEY = DeviceSettings.KEY_SETTINGS_PREFIX + DeviceSettings.KEY_ONEPLUSMODE_SWITCH;

    public static String getFile(Context context) {
        String fileName = context.getResources().getString(R.string.pathOnePlusModeToggle);
